...
// ========================================
function createWindroseHTML_Hourly() {
    var size = 350;
    var center = size / 2;
    ...
    // Use the saved max axis value from max windrose, otherwise calculate from current data
    var maxValue = (typeof window.windroseMaxAxisValue !== 'undefined' && window.windroseMaxAxisValue > 0) ? window.windroseMaxAxisValue : 0;
    if (maxValue === 0) {
    ...
    console.log('[windrose_hourly] Using axis value:', maxValue, 'saved value:', (typeof window.windroseMaxAxisValue !== 'undefined' ? window.windroseMaxAxisValue : 'undefined'));
